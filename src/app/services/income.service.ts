...
export class IncomeService {
  ...
  getCurrentIncome(month: any, year: any): Observable<any> {
    ...
    return this.http.get(`${this.baseUrl}/get-current-income`, {
      params: queryParams,
    });
  }
  ...
  fetchTransactionForCategory(selectedCategory: string) {
    let queryParams = new HttpParams();
    queryParams = queryParams.append('incomeName', selectedCategory);
    return this.http.get(`${this.baseUrl}/get-income`, {
      params: queryParams,
    });
  }
}
